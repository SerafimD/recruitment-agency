...
class VacanciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacancy" do
    assert_difference('Vacancy.count') do
      post vacancies_url, params: { vacancy: { addition_date: @vacancy.addition_date, contact: @vacancy.contact, duration: @vacancy.duration, name: @vacancy.name, salary: @vacancy.salary } }
    end
  ...
  test "should update vacancy" do
    patch vacancy_url(@vacancy), params: { vacancy: { addition_date: @vacancy.addition_date, contact: @vacancy.contact, duration: @vacancy.duration, name: @vacancy.name, salary: @vacancy.salary } }
